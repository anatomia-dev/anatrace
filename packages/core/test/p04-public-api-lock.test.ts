...
// ── The frozen public surface (180 identifiers). Update DELIBERATELY + ship a changeset. ──
const FROZEN_EXPORTS = [
  'Adapter','AdapterCapabilities','AgentRef','BehavioralChannel','COMPLIANCE_CHECK_IDS','COMPLIANCE_PACK','COMPLIANCE_RULES','Capabilities','CaptureCoverage','ChannelCoverageGap','ChannelCoverageGapReason','ChannelEvidencePointer','ChannelInspection','CheckableClaim','ClaimChannelCoverage','ClaimKind','ClaimPredicate','ClaimScope','ClaimSource','ClaimSubject','CommandEvent','ComplianceCheckId','ComplianceResult','ComplianceVerdict','Config','ContentResolver','CostResult','CoverageStat','DERIVE_VERSION','DOSSIER_SCHEMA_VERSION','DelegateManifest','Dossier','DossierClaim','DossierClaimSlice','EVIDENCE_CAP','EditEvent','EvalContext','EvidencePointer','ExpectedLaunchBoundary','ExpectedLaunchLane','ExtractionDiagnostic','FRICTION_DEFAULT_SEVERITY','FRICTION_PACK','FRICTION_RULES','FileScopeDeviationHandling','Finding','GenericPredicate','Harness','HarnessLineageHook','HarnessVersionStatus','HookRequest','IntentClaim','InterruptEvent','JudgeBudget','JudgeFn','JudgeInput','JudgeOutput','JudgeVerdict','LaneCaptureCoverage','LineageCompleteness','LineageExtraction','LineageFanoutCall','LineageGap','LineageGapReason','LineagePointer','MANDATE_ADAPTERS','Mandate','MandateAdapter','MandateClaim','MandateEvaluationContext','Matcher','MessageEvent','MessageTextPredicate','NamedBlob','NormalizedSession','ObservedEgress','ObservedRead','PRICES','PRICE_TABLE_VERSION','ParseHealth','ParserCapability','PathClass','PolicyLoadResult','PolicyVerb','PredicateGuard','PredicateMatcher','PredicateScope','PredicateTarget','PriceEntry','ProvenanceCounts','ReadPath','RepoSnapshot','Report','Rule','RuleOptions','RuleSetting','SCRUB_VERSION','SarifLog','SarifResult','ScrubbedExcerpt','Semver','SessionEvent','SessionEventBody','Severity','SkillEvent','SkillInvocation','SkillOrigin','SkillSource','SourceFidelity','SubagentMeta','TokenCounts','ToolEvent','ToolResultEvent','Tree','UsageEvent','VerdictReason','VerdictStatus','VerificationCoverage','WindowClosesOn','WindowOpensOn','adjudicate','allRules','analyze','anatomiaAdapter','applyIgnores','buildDossier','buildHookRequests','canonicalSort','channelCoverageForClaim','checkIdForClaim','ciExitCode','classifyEditPath','claudeAdapter','codexAdapter','commandStringOf','complianceFindings','complianceKey','computeCost','coverageFromExpectedLaunchBoundary','coverageStat','defaultPack','deriveCounts','detectMandateAdapter','extractLineage','fileScopeVerdict','getRule','harnessVersionAtLeast','harnessVersionStatus','inspectBehavioralChannels','isRootLane','isTranscriptCheckable','isValidMandate','loadPolicyYaml','normalizeEditPath','parseJsonObject','parseSession','readJsonlLines','readPathsOf','renderCoverageLine','resolveOptions','resolvePack','resolveSeverity','rootLaneEvents','runCompliance','sarifLevel','scrubDeep','scrubFinding','scrubText','severityForVerdict','skillsInvoked','skillsInvokedInScope','splitByLane','summarizeVerificationCoverage','superpowersAdapter','toSarif','transcriptContentResolver','unknownComplianceKeys','validateMandate','verdictForClaim','verdictsForMandate',
].sort();
